...
app.post('/api/register', async (req, res) => {
  try {
    ...
    const demoStudents = [
      ...
      { name: '小杰', pet: 'dog', scores: 6, reasons: ['跑步第一','帮助同学'] },
      { name: '小兰', pet: 'fox', scores: 5, reasons: ['讲故事好听','作业整齐'] },
      { name: '小涛', pet: 'turtle', scores: 4, reasons: ['慢慢写好字','不着急'] },
      { name: '小悦', pet: 'panda', scores: 7, reasons: ['值日认真','爱护花草'] },
    ];
